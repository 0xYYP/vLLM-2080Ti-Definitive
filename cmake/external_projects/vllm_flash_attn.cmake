...
# On SM75-only builds, vLLM flash-attn is not used by the serving path we care
# about and would only introduce fetch/build noise. Skip it entirely.
set(_ONLY_SM75 TRUE)
foreach(_ARCH ${VLLM_GPU_ARCHES})
  if (NOT _ARCH STREQUAL "75-real")
    set(_ONLY_SM75 FALSE)
  endif()
endforeach()
if (_ONLY_SM75)
  ...
  message(STATUS "Skipping vllm-flash-attn: unsupported CUDA architecture list ${VLLM_GPU_ARCHES}")
  return()
endif()
