...
2026-08-07 的更高桥记录（4K 70.16）不可复现，已确认与 flashinfer
版本无关。历史重放（c805572 代码 + 0.6.8.post1 + 260 布局）实测 4K 30.05 /
60K 20.07 / 100K 20.06 / 125K 16.19，2026-08-07 记录（70.16 / 44.23 /
32.09）**全部永久标记为不可复现的历史测量**（真实根源应为当时测量方法
差异）；260/272 布局对绝对吞吐的影响未单独隔离（100K 20.06 vs 16.08）。
245K profile 预留 5.9GiB KV 池，每卡仅剩
