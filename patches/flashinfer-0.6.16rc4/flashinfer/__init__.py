...
with contextlib.suppress(ImportError, AttributeError):
    # vllm-2080ti: cutlass/cute-DSL backend unavailable (offline install);
    # MoE GEMM paths are not used by the SM75 int8 attention stack.
...
with contextlib.suppress(ImportError, AttributeError):
    # vllm-2080ti: cute-DSL GEMM backend unavailable offline; not used by
    # the SM75 int8 attention stack.
