...
def is_cute_dsl_available() -> bool:
    ...
    if (
        ...
        return False
    # vllm-2080ti: offline installs may carry an older cutlass whose cute
    # API surface is incomplete (e.g. nvgpu.OperandMajorMode). Require the
    # API used by the CuTe-DSL kernels so the DSL backend stays disabled.
    try:
