...
![Qwen3.6 FP8 KV throughput grouped bar chart](assets/qwen36-kv-throughput-fp8-bars.png)

![Qwen3.6 GPTQ-INT4 KV throughput grouped bar chart](assets/qwen36-kv-throughput-gptq-bars.png)
